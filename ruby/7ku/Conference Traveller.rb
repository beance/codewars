...
# #'Sydney'
p conference_picker(['London', 'Berlin', 'Mexico City', 'Melbourne', 'Buenos Aires', 'Hong Kong', 'Madrid', 'Paris'],
                    %w[Berlin Melbourne])
# 'No worthwhile conferences this year!'
p conference_picker(
  ['Beijing', 'Johannesburg', 'Sydney', 'Philadelphia', 'Hong Kong', 'Stockholm', 'Chicago', 'Seoul', 'Mexico City',
   'Berlin'], %w[Stockholm Berlin Chicago]
)
# 'No worthwhile conferences this year!'
p conference_picker(
